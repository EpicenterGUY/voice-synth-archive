...
"VocaDB 등록 가사":"VocaDB登録歌詞"
  ...
  ,"필요한 쪽만 골라보세요":"必要なものだけ選べます"
  ,"취향이나 코스로 곡 찾기":"好みやコースから曲を探す"
  ,"P · 데이터":"P・データ"
  ,"프로듀서, 순위, 빙산으로 보기":"P・ランキング・アイスバーグから見る"
  ,"순위 계산 방식":"ランキングの計算方法"
  ,"어떤 데이터로 계산하는지 보기":"計算に使うデータを見る"
  ,"이 음원으로 곡 검색":"この音源で曲を検索"
  ,"보컬별 원곡 데이터를 모아 비교하고, 궁금한 음원을 누르면 바로 곡 검색으로 이어집니다.":"ボーカル別のオリジナル曲データをまとめて比較し、気になる音源を押すとそのまま曲検索へ進めます。"
  ,"곡 분포 · 빙산":"曲の分布・アイスバーグ"
  ,"숨은 곡 찾기":"隠れた曲を探す"
  ,"RANKING 2.0":"RANKING 2.0"

  ,"ARCHIVE 2.0":"ARCHIVE 2.0"
  ,"모집단을 고르고 조회수 층을 눌러 바로 곡으로 내려가세요. 자주 쓰는 조건만 앞에 남겼습니다.":"対象範囲を選び、再生数の層からそのまま曲へ進めます。よく使う条件だけを前に出しました。"
  ,"현재 보기":"現在の表示"
  ,"연도 · 빙산 구간 · 정렬":"年代・アイスバーグ層・並び順"
  ,"모집단":"対象範囲"
  ,"자주 쓰는 범위":"よく使う範囲"
  ,"세부 모집단":"詳細な対象範囲"
  ,"VOICEVOX·VoiSona·사용자 태그 등":"VOICEVOX・VoiSona・カスタムタグなど"
  ,"빠른 검색 범위":"クイック検索範囲"
  ,"검색 범위 · 추가 조건":"検索範囲・追加条件"
  ,"CeVIO·VoiSona·연도·빙산·태그 분석":"CeVIO・VoiSona・年代・アイスバーグ・タグ分析"
  ,"전체 검색 범위":"検索範囲"
  ...
  ,"자동 추천 키워드":"おすすめキーワード"
  ,"매번 여러 키워드를 새로 섞어 보여줘요 · 고른 키워드는 유지됩니다.":"毎回キーワードをランダムに入れ替えます。選んだキーワードは残ります。"
  ,"다시 섞기 ↻":"入れ替える ↻"
  ,"빙산 구간":"アイスバーグ層"
  ,"전체 빙산":"すべての層"
  ,"보카로 빙산과 같은 조회수 구간을 사용합니다.":"ボカロアイスバーグと同じ再生数区分を使います。"
  ,"키워드 자동":"キーワード自動"
  ...
  ,"PRODUCER 2.0":"PRODUCER 2.0"
  ,"프로듀서":"プロデューサー"
  ,"P명 검색":"P名検索"
  ,"숨은 P 발굴":"隠れたPを発掘"
  ,"팔로우 중":"フォロー中"
  ,"P 찾아보기":"Pを探す"
  ,"내 기록 기반 후보와 팔로우한 P를 모아봅니다.":"自分の履歴をもとにした候補とフォロー中のPをまとめます。"
  ,"MY LIBRARY 3.0":"MY LIBRARY 3.0"
  ,"내 보관함":"マイライブラリ"
  ,"최근 기록":"最近の履歴"
  ,"랜덤 1곡 ▶":"ランダム1曲 ▶"
  ,"여러 곡 선택":"複数選択"
  ,"곡명 · 태그로 보관함 검색":"曲名・タグでライブラリ検索"
  ,"정리된 곡":"整理済みの曲"
  ,"다시 볼 곡":"あとで見る曲"
  ,"나중에 조사":"あとで調べる"
  ,"더 찾아볼 곡":"さらに調べる曲"
  ,"PRODUCER DETAIL 2.0":"PRODUCER DETAIL 2.0"
  ,"P 목록":"P一覧"
  ,"최고 조회":"最高再生数"
  ...
  ,"중심곡 검색":"中心曲を検索"
  ,"곡명·P명·보컬·태그·sm번호로 새 중심곡을 찾습니다.":"曲名・P名・ボーカル・タグ・sm番号から新しい中心曲を探します。"
  ,"최근 검색 없음":"最近の検索はありません"
  ,"검색 결과 없음":"検索結果なし"
  ,"검색 결과가 없습니다.":"検索結果がありません。"
  ,"곡명·P명·보컬·태그·sm번호를 바꿔보세요.":"曲名・P名・ボーカル・タグ・sm番号を変えてみてください。"
  ,"우주 중심곡을 찾는 중…":"中心曲を検索中…"
  ,"우주 생성 ›":"ユニバースを生成 ›"
  ,"우주를 만들지 못했습니다.":"ユニバースを作成できませんでした。"
  ,"검색하면 후보곡이 여기에 표시됩니다.":"検索すると候補曲がここに表示されます。"
  ,"큰 화면으로 돌아가기":"大きい画面に戻る"
  ,"빠른 이동":"クイック移動"
  ,"검색 범위":"検索範囲"
  ,"현재 불러온 결과 안에서 다시 검색":"現在の結果内を再検索"
  ,"우주 노드 수":"ユニバースのノード数"
  ,"연결 밀도":"接続密度"
  ,"우주 연결 밀도":"ユニバース接続密度"
  ,"음성합성곡 탐색 페이지":"音声合成曲の探索ページ"
  ,"탐정 단계":"探偵ステップ"
  ,"제목 19+ 표기":"タイトルの19+表記"
  ,"19금 콘텐츠를 차단합니다.":"成人向けコンテンツを除外します。"
  ,"19금 필터를 해제했습니다.":"成人向けフィルターを解除しました。"
  ,"집계 대기":"集計待ち"
  ,"사용자 지정 태그":"カスタムタグ"
  ,"정확히 일치시킬 태그를 입력하세요.":"完全一致するタグを入力してください。"
  ,"집계:":"集計:"
  ,"선택 범위 전체":"選択範囲すべて"
  ,"선택 구간":"選択した層"
  ,"통계 갱신 중":"統計を更新中"
  ...
  ,"밝은 화면":"明るい画面"
  ,"중간 밝기":"中程度の明るさ"
  ,"먼저 Worker를 연결하세요.":"先にWorkerを接続してください。"
  ,"후보를 불러오지 못했습니다.":"候補を読み込めませんでした。"
  ,"빙산 전체":"アイスバーグ全体"
  ,"곡 랜덤 추천":"曲をランダムおすすめ"
  ,"우주에 핀을 고정했습니다.":"ユニバースにピン留めしました。"
  ,"핀을 해제했습니다.":"ピン留めを解除しました。"
  ,"유사곡 검색에 사용할 음악 태그가 부족합니다.":"類似曲検索に使える音楽タグが不足しています。"
  ,"공통 태그 적음":"共通タグが少ない"
  ,"앱 내부 검색 연결에 실패했습니다.":"アプリ内検索への接続に失敗しました。"
  ,"Worker 연결이나 검색 조건을 확인해주세요.":"Worker接続または検索条件を確認してください。"
...
function trimTranslate(raw){
  ...
  var rules=[
    ...
    [/^필터 검색$/, "フィルター検索"],
    [/^추천 (\d+)곡$/, "おすすめ $1曲"],
    [/^(\d+)곡 찾음 · 중심곡을 선택하세요$/, "$1曲見つかりました · 中心曲を選んでください"],
    [/^(\d+)곡 찾음 · 선택 범위에서 없어 니코동 전체까지 찾았습니다\.$/, "$1曲見つかりました · 選択範囲になかったためニコニコ全体まで検索しました。"],
    [/^중심곡: (.+) · 우주 생성 중$/, "中心曲: $1 · ユニバース生成中"],
    [/^키워드 선택: (.+)$/, "キーワード選択: $1"],
    [/^키워드 해제: (.+)$/, "キーワード解除: $1"],
    [/^플레이어 음량 (\d+)%$/, "プレーヤー音量 $1%"],
    [/^(.+) 기준$/, "$1 基準"],

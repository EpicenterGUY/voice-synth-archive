...
function boot(){addStyle();ensureFollowUi();addQuickChips();renderActiveFilters();bind();observe();refreshFollow(false);setTimeout(function(){ensureFollowUi();addQuickChips();renderActiveFilters()},500)}

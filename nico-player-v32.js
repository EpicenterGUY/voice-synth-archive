...
function addStyle(){
  ...
  var s=document.createElement("style");s.id="v331PlayerStyle";s.textContent=[
    ...
    ".v331-mini-copy{min-width:0}.v331-mini-copy b{display:block;font-size:9px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.v331-mini-copy small{display:block;margin-top:3px;font-size:7px;color:#6d928e}.v331-mini button{width:34px;height:34px;border:1px solid #2b565d;border-radius:10px;background:#0b2930;color:#dff7f3;font-size:15px}.v331-mini #v3937PlayPauseMini{font-size:13px;font-weight:950}.v331-mini #v3937PlayPauseMini.playing{border-color:#54bdb4;background:#123b41;color:#effffb}.v331-mini #v3924VolumeMini{font-size:11px;font-weight:950}.v331-mini #v3924VolumeMini.active{border-color:#54bdb4;background:#17464c;color:#effffb}.v3926-volume-popover{position:fixed;z-index:32030;width:min(310px,calc(100vw - 24px));display:grid;grid-template-columns:1fr auto;gap:9px;align-items:center;padding:11px;border:1px solid #2c5960;border-radius:14px;background:rgba(6,25,30,.98);box-shadow:0 18px 55px #000b;backdrop-filter:blur(16px)}.v3926-volume-popover[hidden]{display:none!important}.v3926-volume-popover input{grid-column:1/-1;width:100%;accent-color:#68d0c6}.v3926-volume-popover b{font-size:9px}.v3926-volume-popover output{font-size:10px;font-weight:950;color:#dff8f4}.v3926-volume-presets{grid-column:1/-1;display:flex;gap:5px}.v3926-volume-presets button{width:auto!important;height:30px!important;min-width:48px;padding:0 8px;font-size:7px!important;border-radius:999px!important}.v331-player button[hidden],.v331-mini button[hidden]{display:none!important}.v331-mini.v3937-surface-repair{animation:v3937miniIn .16s ease-out}@keyframes v3937miniIn{from{opacity:.35}to{opacity:1}}",
